...
(defn append-inputs-to-sheet! [sheets-client input-1 input-2 input-3 input-4]
  (let [job-id (str (java.util.UUID/randomUUID))
        fn-cell (gs/formula-cell (->function-cell))]
    (gs/append-sheet sheets-client
                    spreadsheet-id
                    inputs-sheet-id
                    [[input-1 input-2 input-3 input-4 fn-cell]])))
